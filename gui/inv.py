...
def dibox_inv(command):
        ...
        label_time = tk.Label(frame_time, text='ろくおんじかん [s]',
                              background="black", foreground="white", 
                              anchor=CENTER, width=20, font=font_def)
        ...
        label_speed = tk.Label(frame_speed, text='さいせいそくど',
                               background="black", foreground="white", 
                               anchor=CENTER, width=20, font=font_def)
        var_speed = tk.StringVar()
        entry_speed = tk.Entry(frame_speed, textvariable=var_speed, borderwidth=5, font=font_def)
        ...
        label_inv = tk.Label(frame_inv, text='オプション', anchor=CENTER, font=font_def,
                             width=20, background="black", foreground="white")
        var_inv = tk.StringVar()
        var_inv.set(True)
        font_inv = f.Font(family="Times News", weight="bold", size=12)
        cb_inv = tk.Checkbutton(frame_inv, text='ぎゃくさいせい',
                                onvalue=True, offvalue=False, width=10, font=font_inv,
                                background="black", activebackground="black",
                                foreground="white", activeforeground="white",
                                selectcolor="black", indicatoron=True,
                                variable=var_inv)
        ...
        cb_save = tk.Checkbutton(frame_save, text='セーブ',
                                 onvalue=True, offvalue=False, width=10, font=font_save,
                                 background="black", activebackground="black",
                                 foreground="white", activeforeground="white",
                                 selectcolor="black", indicatoron=True,
                                 variable=var_save)
        ...
        cb_save_ts = tk.Checkbutton(frame_save_ts, text='セーブ',
                                    onvalue=True, offvalue=False, width=10, font=font_save_ts,
                                    background="black", activebackground="black",
                                    foreground="white", activeforeground="white",
                                    selectcolor="black", indicatoron=True,
        ...
        button_exec = tk.Button(frame_exec, width=8, font=font_def, relief=tk.RAISED,
                                borderwidth=5, text="ろくおん", 
                                command=lambda: command.inverse(record_time=float(var_time.get()), 
                                tofile_origin=int(var_save.get()), tofile_chan=int(var_save_ts.get()),
                                speed=float(var_speed.get()), inv=int(var_inv.get())))
        button_exec.grid(row=0, column=1, padx=50, pady=10, ipadx=10, ipady=10)

        button_out = tk.Button(frame_exec, width=8, font=font_def, relief=tk.RAISED,
                                border=5, text='さいせい', command=lambda: command.write())
